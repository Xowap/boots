...
<div class="app-container">
            ...
            <div class="sidebar-content">
                ...
                <div class="action-group">
                    <button
                        ...
                        onclick={() => openNamingDialog("create")}
                        ><Plus size={16} /> New Study</button
                    >
                    {#if studyManager.currentStudyId}
                        <button
                            class="btn btn-secondary"
                            onclick={() => openNamingDialog("clone")}
                    ...
                    {:else}
                        <button
                            class="btn btn-secondary"
                            onclick={() => openNamingDialog("save_as")}
                ...
                <div class="studies-list">
                    {#each filteredStudies as study}
                        <div
                            class="study-item"
                            class:active={study.id ===
                                studyManager.currentStudyId}
                        >
                            <button
                                class="study-select"
            ...
            <Dialog.Content class="dialog-content">
                ...
                <div class="dialog-field">
                    <input
                        ...
                        onkeydown={(e) =>
                            e.key === "Enter" && handleDialogSubmit()}
                        autofocus
                    />
                </div>
                <div class="dialog-actions">
                    ...
                    <button
                        ...
                        disabled={!dialogStudyName}>Confirm</button
                    >
                </div>
            </Dialog.Content>
        </Dialog.Portal>
        ...
        <Dialog.Portal>
            ...
            <Dialog.Content class="dialog-content questionnaire-content">
                <div class="questionnaire-header">
                    ...
                    <button
                        class="icon-button"
                        onclick={() => (isQuestionnaireOpen = false)}
                        ><X size={20} /></button
                    >
                </div>
                <Dialog.Description class="dialog-description"
                                        ...
                                        <div class="question-item">
                                            ...
                                            <div class="likert-scale">
                                                {#each [{ v: 1, l: "Strongly Disagree" }, { v: 2, l: "Disagree" }, { v: 3, l: "Neutral" }, { v: 4, l: "Agree" }, { v: 5, l: "Strongly Agree" }] as opt}
                                                    <label
                                                        class="likert-option"
                                                        class:active={questionnaireAnswers[
                                                            question.id
                                                        ] === opt.v}
                                                    >
                                                        <input
        ...
        {#if selectedNodeId}
            <div class="panel">
                ...
                <div class="control-group">
                    ...
                    <div
                        class="slider-header"
                        class:disabled={maturity[selectedNodeId]?.mode ===
                            "auto"}
                    >
                    ...
                    <div class="main-score-progress">
                        <div class="progress-track">
                            <div
                                class="progress-fill"
                                style="width: {maturity[selectedNodeId]
                                    ?.score ??
    ...
    <div class="legend">
        <div class="legend-item">
            <span class="dot" style="background: #ef4444"></span> Low (0-24%)
        </div>
        <div class="legend-item">
            <span class="dot" style="background: #f97316"></span> Medium (25-49%)
        </div>
        <div class="legend-item">
            <span class="dot" style="background: #f59e0b"></span> High (50-74%)
        </div>
        <div class="legend-item">
            <span class="dot" style="background: #22c55e"></span> Elite (75-100%)
        </div>
        <div class="legend-separator"></div>
        <div class="legend-item">
            <span class="box solid"></span> Manual Mode
        </div>
        <div class="legend-item">
            <span class="box dashed"></span> Auto (PageRank)
        </div>
    </div>
</div>
